...
class KNearestNeighbor(object):
    ...
    def predict(self, X, k=1, num_loops=0):
        ...
        Inputs:
        - X: A numpy array of shape (num_test, D) containing
             test data consisting of num_test samples each of dimension D.
        - k: The number of nearest neighbors that vote for
             the predicted labels.
        - num_loops: Determines which implementation to use
        ...
        - y: A numpy array of shape (num_test,)
             ...
             test data, where y[i] is the predicted
             label for the test point X[i].
        """
        if num_loops == 0:
